...
function CategoryAddForm({
  ...
  return (
    <motion.form
      ...
      className="mt-3 overflow-hidden rounded-2xl border border-[#5b4cf0]/15 bg-gradient-to-br from-[#f5f4ff] to-white p-5 shadow-[0_12px_32px_rgba(91,76,240,0.06)]"
    >
...
function CategoryTreeNode({
  ...
  return (
    <div className="relative">
      ...
      {depth > 0 && (
        <div 
          className="absolute left-4 top-0 h-full w-px bg-gradient-to-b from-slate-200 via-slate-100 to-transparent" 
